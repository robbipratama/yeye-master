	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
                ...
                @endif
				<form class="login100-form validate-form flex-sb flex-w" action="{{ url('/cek-login') }}" method="post">
					{{ csrf_field() }}
				...
				<a href="{{ url('/') }}"><span class="fa fa-arrow-left"></span> Back to Home</a> / <a href="{{ url('/register') }}">Register</a>
			</div>
			<br/><br/>
		</div>
	</div>
